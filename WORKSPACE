...
go_repository(
    ...
    sum = "h1:Rlny7+KML4VP5IePH+GKR4ijQoNKQP6CZbeLHm+XGdI=",
    version = "v0.0.0-20210503113509-c650019f8069",
)
...
go_repository(
    ...
    sum = "h1:pAwJxDByZctfPwzlNGrDN2BQLsdPb9NkhoTJtUkAO28=",
    version = "v0.0.0-20210503080704-8803ae5d1324",
)
